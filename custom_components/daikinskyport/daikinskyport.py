...
class DaikinSkyport(object):
    ...
    def get_sensors(self, index):
        ...
        sensors.append({"name": f"{name} Indoor liquid", "value": thermostat['ctAHLiquidTemperature'], "type": "temperature"})
        sensors.append({"name": f"{name} Outdoor liquid", "value": thermostat['ctOutdoorLiquidTemperature'], "type": "temperature"})
